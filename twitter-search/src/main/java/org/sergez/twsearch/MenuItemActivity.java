...
public class MenuItemActivity extends BaseActivity {
    ...
    private void showSearchView() {
        ...
        mSuggestionsList.add(new SearchItem("Ondo"));
        ...
        mSuggestionsList.add(new SearchItem("Benin"));
        mSuggestionsList.add(new SearchItem("Sokoto"));
        mSuggestionsList.add(new SearchItem("Jigawa"));
        mSuggestionsList.add(new SearchItem("Yobe"));
        mSuggestionsList.add(new SearchItem("Kaduna"));
        mSuggestionsList.add(new SearchItem("Kongi"));
